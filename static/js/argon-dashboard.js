...
var tooltipTriggerList = [].slice.call(document.querySelectorAll('[exstract-bs-toggle="tooltip"]'))
...
if (document.querySelector('.fixed-plugin')) {
  ...
  if (navbar) {
    if (navbar.getAttribute('exstract-scroll') == 'true' && buttonNavbarFixed) {
...
function sidebarColor(a) {
  ...
  var color = a.getAttribute("exstract-color");
  ...
  var sidebar = document.querySelector('.sidenav');
  sidebar.setAttribute("exstract-color", color);
...
function sidebarType(a) {
  var parent = a.parentElement.children;
  var color = a.getAttribute("exstract-class");
  ...
  for (var i = 0; i < parent.length; i++) {
    parent[i].classList.remove('active');
    colors.push(parent[i].getAttribute('exstract-class'));
  }
...
function navbarFixed(el) {
  ...
  if (!el.getAttribute("checked")) {
    ...
    navbar.setAttribute('exstract-scroll', 'true');
    navbarBlurOnScroll('navbarBlur');
    el.setAttribute("checked", "true");
  } else {
    toggleNavLinksColor('transparent');
    navbar.classList.remove(...classes);
    navbar.setAttribute('exstract-scroll', 'false');
    navbarBlurOnScroll('navbarBlur');
...
function navbarBlurOnScroll(id) {
  ...
  let navbarScrollActive = navbar ? navbar.getAttribute("exstract-scroll") : false;
...
let referenceButtons = document.querySelector('[exstract-class]');

window.addEventListener("resize", navbarColorOnResize);

function navbarColorOnResize() {
  if (window.innerWidth > 1200) {
    if (referenceButtons.classList.contains('active') && referenceButtons.getAttribute('exstract-class') === 'bg-transparent') {
      sidenav.classList.remove('bg-white');
    } else {
